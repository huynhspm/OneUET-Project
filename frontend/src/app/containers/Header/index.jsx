			...
			<div className="header bg-light">
				...
				<div className="profile-group dropdown">
					...
					<ul class="dropdown-menu">
						<li>
							<Link class="dropdown-item" to="/profile/infomation">
								<AccountBoxIcon /> Cập nhật thông tin
							</Link>
						</li>
						<li>
							<Link class="dropdown-item" to="/profile/schedule">
								<CalendarMonthIcon />
								Thời khóa biểu
							</Link>
						</li>
						<li>
							<Link class="dropdown-item" to="/profile/learning-result">
								<EmojiEventsIcon />
								Kết quả học tập
							</Link>
						</li>
						<li>
							<Link class="dropdown-item" to="/profile/private-document">
								<FolderSharedIcon />
								Tài liệu cá nhân
							</Link>
						</li>
						<li>
							<Link class="dropdown-item" to="/profile/change-password">
								<SyncLockIcon />
								Đổi mật khẩu
							</Link>
						</li>
