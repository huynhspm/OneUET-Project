			...
			<div className="header bg-light">
				...
				<div className="profile-group dropdown">
					...
					<ul className="dropdown-menu">
						<li>
							<Link className="dropdown-item" to="/profile/infomation">
								<AccountBoxIcon /> Cập nhật thông tin
							</Link>
						</li>
						<li>
							<Link className="dropdown-item" to="/profile/schedule">
								<CalendarMonthIcon />
								Thời khóa biểu
							</Link>
						</li>
						<li>
							<Link className="dropdown-item" to="/profile/learning-result">
								<EmojiEventsIcon />
								Kết quả học tập
							</Link>
						</li>
						<li>
							<Link className="dropdown-item" to="/profile/private-document">
								<FolderSharedIcon />
								Tài liệu cá nhân
							</Link>
						</li>
