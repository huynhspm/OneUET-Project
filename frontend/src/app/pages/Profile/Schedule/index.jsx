...
const RoomScheduler = (props) => {
	...
	const fetchData = async () => {
		try {
			...
			await axios.get(api_url + "/api/user/me", config).then((res) => {
	...
	return (
		<div className="k-my-8">
			<Button className="buttonSchedule" onClick={handleExportWithComponent}>EXPORT SCHEDULE</Button>
			<Button className="buttonSchedule" onClick={handleNeatSchedule}>{isNeat === true ? "FULL INFORMATION" : "COMPACT INFORMATION"}</Button>
